...
path(
    "store/<slug:store_slug>/save-shipping-address/",
    storefront.save_shipping_address,
...
path(
    "<slug:store_slug>/wishlist/remove/<int:product_id>/",
    storefront.remove_wishlist,
...
path(
    "<slug:store_slug>/policy/<str:policy_type>/",
    storefront.store_policy,
    name="store_policy",
),

# ==========================================================
# المتجر - المنتجات والعروض
# ==========================================================

path(
    "<slug:store_slug>/offers/",
    storefront.offers,
    name="offers",
),
